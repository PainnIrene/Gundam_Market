    ...
    e.preventDefault();
      ...
      try {
       ...
       //  const response = await fetch('http://localhost:5000/post/upload', {
         const response = await fetch('https://gundam-market-be.vercel.app/post/upload', {
          method: 'POST',
          headers: {
...
Create Post
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                />
                {previewImage && (
                  <img src={previewImage} alt="Preview" style={{ maxWidth: '200px' }} className="h-auto max-w-lg rounded-lg m-auto mt-10" />
                )}
              </div>
              <button
                type="submit"
