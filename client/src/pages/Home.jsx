...
function Home() {
  ...
  const fetchPosts = async () => {
    try {
          const response = await fetch('https://gundam-market-be.vercel.app/post/posts', {
...
<div style={{ backgroundImage: `url(${gundamImg})`}} className="h-screen w-full p-0">
  {showCreatePostForm && <CreatePost setCreatePostForm={setCreatePostForm} />}
    ...
    <div className="w-[300px] m-h-[600px] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2 "key={post._id} >
    <img className="rounded-t-lg max-h-[200px] m-auto mt-10" src={post.photo} alt="Post"/>
  <div className="p-5">
